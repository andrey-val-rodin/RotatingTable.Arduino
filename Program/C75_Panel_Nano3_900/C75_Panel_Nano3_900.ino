...
class Settings
{
    ...
    private:
        static float getTimeOfTurn(unsigned char pwm)
        {
            ...
            {
                255, 244, 216, 188, 169, 152, 140, 128, 118, 109, 103, 97, 91, 86, 82, 77, 74, 70, 68, 65,
                62, 60, 58, 56, 55, 53, 51, 50, 49, 48, 47, 46, 45, 44, 43, 42, 41, 41, 40, 39,
                38, 38, 37, 37, 36, 36, 35, 35, 34, 33, 33, 32, 32, 32, 31, 31, 31, 31, 30, 30,
                30, 29, 29, 29, 28, 28, 28, 28, 27, 27, 27, 27, 26, 26, 26, 26, 25, 25, 25, 25,
                24, 24, 24, 24, 24, 23, 23, 23, 23, 22, 22, 22, 22, 21, 21, 21, 21, 21, 20, 20,
                20, 20, 20, 19, 19, 19, 19, 19, 19, 18, 18, 18, 18, 18, 18, 18, 18, 17, 18, 17,
                17, 17, 17, 17, 16, 16, 16, 16, 16, 16, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15,
