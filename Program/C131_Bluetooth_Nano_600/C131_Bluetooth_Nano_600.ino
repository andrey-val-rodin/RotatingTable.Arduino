...
class Settings
{
    ...
    private:
        ...
        static float getTimeOfTurn(unsigned char pwm)
        {
            ...
            {
                168, 151, 138, 126, 117, 108, 101, 94, 89, 83, 78, 74, 70, 67, 64, 61, 58, 55, 53, 51,
                49, 47, 45, 44, 42, 41, 39, 38, 37, 36, 35, 34, 33, 32, 32, 31, 30, 29, 29, 28,
                27, 27, 26, 26, 25, 24, 24, 24, 24, 24, 24, 23, 23, 22, 22, 21, 21, 21, 20, 20,
                20, 20, 19, 19, 19, 19, 18, 18, 19, 18, 18, 18, 17, 17, 17, 16, 16, 16, 16, 16,
                15, 15, 15, 15, 15, 14, 14, 14, 14, 14, 14, 13, 13, 13, 13, 13, 13, 13, 13, 13,
                13, 12, 12, 12, 12, 12, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 10, 10, 10,
