...
class Settings
{
    ...
    private:
        ...
        static float getTimeOfTurn(unsigned char pwm)
        {
            ...
            {
                228, 197, 176, 157, 143, 131, 120, 111, 104, 96, 90, 84, 80, 75, 71, 68, 64, 61, 59, 56, 
                53, 51, 49, 47, 46, 44, 43, 41, 40, 39, 38, 36, 35, 35, 34, 33, 32, 31, 30, 30,
                29, 28, 28, 27, 27, 26, 26, 25, 24, 24, 25, 24, 24, 24, 23, 23, 23, 22, 22, 21,
                21, 21, 20, 20, 20, 20, 19, 19, 19, 18, 19, 19, 18, 18, 17, 17, 17, 17, 16, 16,
                16, 16, 15, 15, 15, 15, 15, 15, 15, 14, 14, 14, 14, 14, 13, 13, 13, 13, 13, 13,
                13, 13, 13, 13, 12, 12, 12, 12, 12, 12, 12, 11, 11, 11, 11, 11, 11, 11, 11, 11,
                11, 11, 11, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10,
