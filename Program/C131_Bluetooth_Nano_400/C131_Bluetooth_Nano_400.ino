...
class Settings
{
    ...
    private:
        ...
        static float getTimeOfTurn(unsigned char pwm)
        {
            ...
            {
                95, 87, 81, 75, 71, 66, 63, 59, 56, 53, 51, 48, 47, 45, 43, 42, 40, 39, 37, 36, 35,
                34, 34, 33, 32, 31, 31, 30, 29, 29, 28, 28, 27, 27, 27, 26, 26, 25, 25, 25, 24, 24,
                24, 23, 23, 23, 22, 22, 22, 22, 21, 21, 21, 21, 21, 21, 20, 20, 20, 20, 20, 19, 19,
                19, 19, 19, 18, 18, 18, 18, 18, 18, 17, 17, 17, 17, 17, 17, 16, 16, 16, 16, 16, 16,
                16, 16, 15, 15, 15, 15, 15, 15, 15, 14, 14, 14, 14, 14, 14, 14, 14, 13, 13, 13, 13,
                13, 13, 13, 13, 13, 13, 12, 13, 12, 12, 12, 12, 12, 12, 12, 12, 11, 11, 11, 11, 11,
                11, 11, 11, 11, 11, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 9, 9, 9, 9, 9, 9, 9, 9,
