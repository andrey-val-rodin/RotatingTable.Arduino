...
Начальный ШИМ не может увеличиваться бесконечно, верний лимит равен 100. Этот лимит может быть уменьшен, если, например, задано перемещение на малое расстояние.
